            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
              <div className="space-y-4">
                ...
                <p className="text-gray-600">
                  ...
                  technologies that require fundamental knowledge to safely
                  operate and maintain. The integration of these emerging
                  technologies with established technologies, such as balance of
                  plant equipment, is not often available through the technology
                  manufacturers.
                </p>
                <p className="text-gray-600">
                  There is no one-stop, turn-key solution because of
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-7xl">
            ...
            <div className="grid gap-6 lg:grid-cols-4">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  We help you choose the most suitable hydrogen technologies for
                  your specific needs.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <h3 className="text-xl font-bold mb-2">Integration Planning</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  We oversee the entire implementation process, ensuring smooth
