  ...
  social: [
    {
      ...
      icon: (props) => (
        <svg xmlns="http://www.w3.org/2000/svg" x="2px" y="2px" width="70" height="70" viewBox="0 0 30 30" {...props}> 
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6  py-20 sm:py-24 lg:px-8">
        ...
        <div className="mt-10 flex justify-center space-x-10">
          {navigation.social.map((item) => (
            <a key={item.name} href={item.href} target="_blank" rel="noopener noreferrer"className="text-header-3 hover:text-gray-500">
