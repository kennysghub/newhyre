            ...
            <figure className="mt-10 flex flex-auto flex-col justify-between">
              ...
              <figcaption className="mt-10 flex items-center gap-x-6">
                <img
                  ...
                  src="https://www.kennethnguyen.io/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fportrait.8167ba6c.png&w=128&q=75"
                  alt=""
                />
                <div className="text-base">
                  <div className="font-semibold text-gray-900">Kenneth Nguyen</div>
                  <div className="mt-1 text-gray-500">CEO of Northrop Gruman</div>
                </div>
              </figcaption>
            </figure>
          </div>
          <div className="flex flex-col border-t border-gray-900/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20">
            ...
            <figure className="mt-10 flex flex-auto flex-col justify-between">
              ...
              <figcaption className="mt-10 flex items-center gap-x-6">
                <img
                  className="h-14 w-14 rounded-full bg-gray-50"
                  src="https://media.licdn.com/dms/image/D5603AQHUd4MKtUSlnw/profile-displayphoto-shrink_400_400/0/1696753420277?e=1704326400&v=beta&t=LjdvvXOJrOWfg8hfvbq7WKzC3vLDpzPKBvydjfqyVR4"
                  alt=""
                />
                <div className="text-base">
                  <div className="font-semibold text-gray-900">Also Kenneth Nguyen</div>
                  <div className="mt-1 text-gray-500">Engineering Director of Boeing </div>
                </div>
              </figcaption>
            </figure>
          </div>
