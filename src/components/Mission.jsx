          ...
          <ul role="list" className="space-y-8 text-gray-600">
            <li className="flex gap-x-3">
              ...
              <span className="text-gray-50">
                <strong className="font-semibold text-header-3">Cutting-Edge Technology Applications for Global Decarbonization</strong>
                <br />
            ...
            <li className="flex gap-x-3">
              ...
              <span className="text-gray-50">
                ...
                so collaborations across the entire energy industry are welcomed.
              </span>
            </li>
            <li className="flex gap-x-3">
              <CheckCircleIcon
